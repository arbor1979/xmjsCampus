 ...
 * 
 * <br/>
 * 创建说明: 2013-11-23 下午3:35:29 wanggz 创建文件<br/>
 * 
 * 修改历史:<br/>
 * 
 */
...
public class ImageManager2 {
	...
	private static CampusApplication myapp;
	...
	public static ImageManager2 from(Context context) {
		...
		if (myapp == null) {
			myapp = (CampusApplication) context.getApplicationContext();
		}
		...
		public void handleMessage(Message msg) {
			...
			case MSG_REQUEST: // 收到请求
				...
				if (msg.obj != null && msg.obj instanceof ImageRef) {
					...
					if (url.toLowerCase().contains("sdcard")
							|| url.toLowerCase().contains("storage")) {
