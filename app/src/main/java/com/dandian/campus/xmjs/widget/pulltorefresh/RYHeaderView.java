package com.dandian.campus.xmjs.widget.pulltorefresh;
 ...
 * 版本说明: $id:$ <br/>
 * 
 * 功能说明: 可下拉刷新ListView头部
 * 
 * <br/>
 * 创建说明: 2013-12-7 下午2:32:37 wanggz 创建文件<br/>
 * 
 * 修改历史:<br/>
 * 
 */
public class RYHeaderView extends LinearLayout {
	...
	public RYHeaderView(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param attrs
	 */
	public RYHeaderView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
